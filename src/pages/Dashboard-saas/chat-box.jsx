            ...
            <Row>
              <Col md={4} xs={9}>
                ...
                <p className="text-muted mb-0">
                  <i className="mdi mdi-circle text-success align-middle me-1" /> Active now
                </p>
              </Col>
              <Col md={8} xs={3}>
                    ...
                    <Dropdown isOpen={searchMenu} toggle={() => setSearchMenu(!searchMenu)}>
                      ...
                      <DropdownMenu className="dropdown-menu-end py-0 dropdown-menu-md">
                        <Form className="p-3">
                          <div className="m-0">
                            <InputGroup>
                              <Input type="text" placeholder="Search ..." aria-label="Recipient's username" onChange={handleChange} />
          ...
          <CardBody className="pb-0">
            <div>
              <div className="chat-conversation">
                <SimpleBar style={{ marginBottom: "1rem", maxHeight: "260px" }} ref={messageBox}>
            ...
            <Row>
              <Col>
                <div className="position-relative">
                  <Input type="text" className="form-control rounded chat-input" placeholder="Enter Message..." value={text} onChange={e => setText(e.target.value)} />
              ...
              <div className="col-auto">
                <Button type="submit" color="primary" className="chat-send w-md " onClick={() => onSendMessage()}>
