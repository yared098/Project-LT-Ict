...
dep_available_at_region:(department && department.dep_available_at_region) || "", 
dep_available_at_zone:(department && department.dep_available_at_zone) || "", 
dep_available_at_woreda:(department && department.dep_available_at_woreda) || "", 
...
dep_available_at_region: Yup.string().required(t('dep_available_at_region')),
dep_available_at_zone: Yup.string().required(t('dep_available_at_zone')),
dep_available_at_woreda: Yup.string().required(t('dep_available_at_woreda')),
      ...
      }, 
{
        ...
        cell: (cellProps) => {
          return (
            <span>
              {truncateText(cellProps.row.original.dep_available_at_region, 30) ||
                '-'}
            </span>
          );
        },
      ...
      }, 
{
        ...
        cell: (cellProps) => {
          return (
            <span>
              {truncateText(cellProps.row.original.dep_available_at_woreda, 30) ||
                '-'}
            </span>
          );
        },
        ...
        <div className="container-fluid">
          ...
          <Modal isOpen={modal} toggle={toggle} className="modal-xl">
            <ModalHeader toggle={toggle} tag="h4">
              {!!isEdit ? (t("edit") + " "+t("department")) : (t("add") +" "+t("department"))}
            </ModalHeader>
            <ModalBody>
              <Form
                onSubmit={(e) => {
